    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Bethany Presbyterian Church</h3>
            <p className="text-sm mb-4">
              A welcoming community of believers committed to serving God and our neighbors.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>Email: info@bethanypc.org.sg</li>
